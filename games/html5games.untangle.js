/**
 * Created by nsnguyen on 3/25/14.
 */
...
//exclude result when a==b or b==c
function isInBetween(a,b,c){
    //return false if b is almost equal to a or c
    //this is to eliminate som floating point when two value is equal to each other but different with 0.0000...0001
...
//function to check whether lines intersect and mark that line in bold
...
$(function(){
    ...
    //setup an interval top loop the game loop
